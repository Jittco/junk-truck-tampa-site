          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <a 
                ...
                aria-label="Book junk removal and demolition"
              >
                Book Now
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-t shadow-lg">
              <div className="px-4 py-4 space-y-2 max-w-7xl mx-auto">
                <a 
                  href="#home" 
                  className="block py-3 px-4 text-foreground font-inter hover:bg-muted rounded"
                  ...
                  <div className="pl-4 space-y-2">
                    {services.map((service) => (
                      <a 
                        key={service}
                        href="#services" 
                        className="block py-2 text-foreground font-inter hover:bg-muted rounded"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        {service}
                      </a>
