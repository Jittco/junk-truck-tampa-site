import { Home, Building, Wrench, Key, Briefcase, Heart, Truck, MapPin, Hammer, TreePine, Users, Church } from "lucide-react";
  ...
  return <section className="py-16 bg-[#222222]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-5xl mx-auto text-slate-50">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-card rounded-lg border p-6">
            ...
            <div className="space-y-4">
              {situations.map((situation, index) => <div key={index} className="flex items-start">
          ...
          <div className="bg-card rounded-lg border p-6">
            ...
            <div className="space-y-4">
              {whoUsesUs.map((user, index) => <div key={index} className="flex items-start">
                  <div className="text-primary mr-3 mt-0.5 flex-shrink-0">
                    {user.icon}
                  </div>
        ...
        <div className="text-center mt-12">
          <p className="text-lg mb-6 text-slate-50">
