...
const BOOK_URL =
  "https://book.housecallpro.com/book/JunkintheTrunkco/2eef934dbbae44e09e5d7b3ec87330ae";
...
export default function HowItWorks({
  ...
  const steps = [
    {
      ...
      desc:
        "Book online in seconds or call us to pick a time that works for you. Same‑day and next‑day junk removal often available.",
      img: step1Img,
    },
    {
      title: "On‑Site Estimate",
      desc:
        "Our friendly team arrives on time, reviews what you'd like removed, and gives a transparent, upfront estimate before any work begins.",
      img: step2Img,
    },
    {
      title: "We Haul Everything Away",
      desc:
        "Approve the quote and we get to work immediately—safe lifting, quick loading, careful clean‑up, and responsible disposal or recycling.",
      img: step3Img,
    },
    {
      title: "Reclaim Your Space",
      desc:
        "Enjoy a clutter‑free home, yard, or office. Fast, fair, and hassle‑free junk removal from a local team you can trust.",
      img: step4Img,
    },
  ];
  ...
  const howToJsonLd = {
    ...
    "description":
      "Simple, transparent junk removal: book online or call, get a fair on‑site estimate, we haul everything away, and you reclaim your space.",
    "step": steps.map((s, i) => ({
      "@type": "HowToStep",
      "position": i + 1,
      "name": s.title,
  ...
  return (
    <section
      className={`w-full py-12 md:py-16 lg:py-20 bg-background ${className}`}
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="text-center mb-12 md:mb-16">
          <h2
            ...
            className="font-anton text-3xl md:text-4xl lg:text-5xl text-foreground mb-4"
          >
