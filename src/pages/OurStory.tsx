...
const OurStory = () => {
  return <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Locally owned, Christian-based Tampa Bay junk removal in South Tampa. Licensed, insured, 5-star rated with 400+ reviews. Not a franchise." />
        ...
        <meta property="og:description" content="Locally owned, Christian-based Tampa Bay junk removal in South Tampa. Licensed, insured, 5-star rated with 400+ reviews." />
